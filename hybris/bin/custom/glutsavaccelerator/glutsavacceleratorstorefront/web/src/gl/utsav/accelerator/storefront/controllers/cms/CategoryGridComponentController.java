 ...
 */
@Controller("CategoryGridComponentController")
@Scope("tenant")
@RequestMapping(value = ControllerConstants.Actions.Cms.CategoryGridComponent)
public class CategoryGridComponentController extends AbstractCMSComponentController<CategoryGridComponentModel>
{
