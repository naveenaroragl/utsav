 ...
 *
 */
package gl.utsav.accelerator.storefront.interceptors;
...
import gl.utsav.accelerator.storefront.util.CSRFHandlerInterceptor;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "gl.utsav.accelerator.storefront.util.CSRFTokenManager.tokenval";
