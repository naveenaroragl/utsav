	...
	<form:form action="${action}" method="post" commandName="loginForm">
		...
		<div class="form_field-elements">
			<formElement:formInputBox idKey="j_username" labelKey="login.email"
				path="j_username" inputCSS="text" mandatory="true" />
			<formElement:formPasswordBox idKey="j_password"
				labelKey="login.password" path="j_password" inputCSS="text password"
				mandatory="true" />
			...
			<div class="form_field_error-message">
				<a href="javascript:void(0)"
					...
					class="password-forgotten"><spring:theme
						code="login.link.forgottenPwd" /></a>
			</div>

			<div class="form_field_error-message">
				<a
					href="<c:url value='https://www.facebook.com/dialog/oauth?client_id=531112010392992&redirect_uri=https://localhost:9002/glutsavacceleratorstorefront/en/loginFacebook/request&scope=email'/>">
					<spring:theme code="login.link.facebook" />
				</a>
			</div>
			...
			<div class="form_field_error-message">
				<a
					...
					<spring:theme code="login.link.google" />
				</a>
			</div>
