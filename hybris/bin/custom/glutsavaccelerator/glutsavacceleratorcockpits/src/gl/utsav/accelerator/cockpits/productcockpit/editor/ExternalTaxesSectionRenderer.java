 ...
 *
 */
package gl.utsav.accelerator.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("glutsavacceleratorcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("glutsavacceleratorcockpits.product.externalTaxes"));
