 ...
 *
 */
package gl.utsav.accelerator.core.suggestion;
...
import gl.utsav.accelerator.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/glutsavacceleratorcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
