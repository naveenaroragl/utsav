 ...
 *
 */
package gl.utsav.accelerator.core.hmc;
...
/**
 * Provides necessary meta information about the glutsavacceleratorcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class GlutsavacceleratorCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(GlutsavacceleratorCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "gl.utsav.accelerator.core.hmc.locales";
