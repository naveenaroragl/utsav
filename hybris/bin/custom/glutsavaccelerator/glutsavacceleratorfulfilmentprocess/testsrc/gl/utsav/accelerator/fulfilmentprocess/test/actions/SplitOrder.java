 ...
 *
 */
package gl.utsav.accelerator.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GlutsavacceleratorFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GlutsavacceleratorFulfilmentProcessConstants.PARENT_PROCESS);
