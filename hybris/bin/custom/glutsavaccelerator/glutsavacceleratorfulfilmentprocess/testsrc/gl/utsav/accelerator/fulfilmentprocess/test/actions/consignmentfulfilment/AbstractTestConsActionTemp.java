 ...
 *
 */
package gl.utsav.accelerator.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, GlutsavacceleratorFulfilmentProcessConstants.PARENT_PROCESS);
