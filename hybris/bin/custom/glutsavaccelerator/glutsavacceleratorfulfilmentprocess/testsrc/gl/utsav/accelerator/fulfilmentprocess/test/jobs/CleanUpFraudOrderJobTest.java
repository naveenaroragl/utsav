 ...
 *
 */
package gl.utsav.accelerator.fulfilmentprocess.test.jobs;
...
import gl.utsav.accelerator.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GlutsavacceleratorFulfilmentProcessConstants.ORDER_PROCESS_NAME;
