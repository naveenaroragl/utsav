 ...
 *
 */
package gl.utsav.accelerator.test.setup;
...
import gl.utsav.accelerator.test.constants.GlutsavacceleratorTestConstants;
import gl.utsav.accelerator.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GlutsavacceleratorTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/glutsavacceleratortest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/glutsavacceleratortest/import/reviews.impex");
			...
			importImpexFile(context, "/glutsavacceleratortest/import/cstickets.impex");
		}
	}
}
