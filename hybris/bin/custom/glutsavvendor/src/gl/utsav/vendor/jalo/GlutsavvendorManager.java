...
import gl.utsav.vendor.constants.GlutsavvendorConstants;



/**
 * This is the extension manager of the Glutsavvendor extension.
 */
public class GlutsavvendorManager extends GeneratedGlutsavvendorManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GlutsavvendorManager.class.getName());
	 ...
	 */
	public static GlutsavvendorManager getInstance()
	{
		return (GlutsavvendorManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GlutsavvendorConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GlutsavvendorManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GlutsavvendorManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GlutsavvendorManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GlutsavvendorManager called, current tenant: " + getTenant().getTenantID());
		}
	}
