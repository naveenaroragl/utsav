 ...
 */
package gl.utsav.backoffice.jalo;
...
import gl.utsav.backoffice.constants.GlutsavbackofficeConstants;
 ...
 */
public class GlutsavbackofficeManager extends GeneratedGlutsavbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GlutsavbackofficeManager.class.getName());
	 ...
	 */
	public static GlutsavbackofficeManager getInstance()
	{
		return (GlutsavbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(GlutsavbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GlutsavbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GlutsavbackofficeManager called.");
		}
	}
